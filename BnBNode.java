...
public class BnBNode {
	 ...
	 */
	public BnBNode(BnBNode parent, double parent_cost, double[][] distances, int[] active_set, int index) {
		this.parent = parent;
	 ...
	 */
	public BnBNode[] generateChildren() {
		BnBNode[] children = new BnBNode[active_set.length - 1];
		...
		for(int j = 0; j < children.length; j++)
			children[j] = new BnBNode(this, distances[index][new_set[j]], distances, new_set, new_set[j]);
